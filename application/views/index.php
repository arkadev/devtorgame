        ...
        <div class="banner-informations bnn-colors bnn-equipo">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 title-info">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-3 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
                    <h4>Nuestro equipo está conformado por cuatro estudiantes de ingeniería de sistemas y computación de la universidad pedagógica y tecnológica de Colombia (UPTC) que siempre van a estar a tus servicios para apoyarte en tu proceso de creación de torneos.</h4>
                </div>
            </div>
        </div>
    </body>
