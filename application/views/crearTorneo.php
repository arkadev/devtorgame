	...
	<body style="background-color: #EEEEEE">
				...
				<div class="navbar-header">
					...
					<div>
						<div class="col-xs-4 col-sm-4 col-md-4">
							<img src="img/Logo.png" class="img-responsive img-menu">
						</div>
						<div class="col-xs-4 col-sm-4 col-md-4">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
				<img src="img/lol11.jpg" class="img-add-tournament">
			</div>
		</div>
		<div class="row">
			<div name="add-tournament-btn">
				<button class="col-xs-12 col-sm-12 col-md-2 col-md-offset-2 add-tournament" data-toggle="modal" data-target="#myModal">
					<div class="margin-icon">
						<img src="img/add-icon.png" class="icon-add-tournament">
					</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-10">
					<div class="modal-content">
						<div class="add-img-btn">
							<img src="img/lol11.jpg" class="img-responsive">
						</div>
						<div id="baner-color" class="add-dates-tournametn">
							<div>
								<input type="text" class="text-name-tournament" placeholder="Nombre de torneo">
							</div>
						...
						<div class="container-fluid">
							...
							<div class="col-xs-12 col-sm-12 col-md-1 col-md-offset-2">
								<button class="btn-add-tournamet-validate">CREAR</button>
							</div>
						</div>
					</div>
				</div>
