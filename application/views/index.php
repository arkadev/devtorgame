		...
		<div id="page-wrapper">
						...
						<li class="special">
							...
							<div id="menu">
								<ul>
									...
									<li id="btn-r-index"><a href="<?= base_url() . 'signUp' ?>">REGISTRARSE</a></li>
									<li id="btn-i-index"><a href="<?= base_url() . 'signIn' ?>">INICIAR SESIÓN</a></li>
									<li id="btn-m-index" style="display:none"><a href="<?= base_url() . 'manager' ?>">Mis TORNEOS</a></li>
									<li id="btn-c-index" style="display:none"><a href="">CERRAR SESIÓN</a></li>
								</ul>
							</div>
							<ul class="ul-index">
								...
								<li id="btn-i2-index" class="li-index"><a href="<?= base_url() . 'signIn' ?>" class="a1">INICIAR SESIÓN</a></li>
								<li id="btn-m2-index" class="li-index" style="display:none"><a href="<?= base_url() . 'manager' ?>" class="a1">Mis TORNEOS</a></li>
								<li id="btn-c2-index" class="li-index" style="display:none"><a class="a1" href="">CERRAR SESIÓN</a></li>
							</ul>
						</li>
					</ul>
				</nav>
			...
			<section id="banner">
				<div class="inner">
					...
					<ul class="actions">
						<li id="btn-m3-index" style="display:none"><a href="<?= base_url() . 'manager' ?>" class="button special" >Comenzar</a></li>
						<li id="btn-r2-index"><a href="<?= base_url() . 'signUp' ?>" class="button special">Registrate</a></li>
					</ul>
				</div>
			...
			<section id="cta" class="wrapper style4">
				<div class="inner">
					...
					<ul class="actions vertical">
						<li id="btn-m4-index" style="display:none"><a href="<?= base_url() . 'manager' ?>" class="button fit special">Mis TORNEOS</a></li>
						<li id="btn-c3-index" style="display:none"><a class="button fit">CERRAR SESIÓN</a></li>
						<li id="btn-r3-index"><a href="<?= base_url() . 'signUp' ?>" class="button fit special">REGISTRARSE</a></li>
						<li id="btn-i3-index"><a href="<?= base_url() . 'signIn' ?>" class="button fit">INICIAR SESIÓN</a></li>
					</ul>
				</div>
			</section>
			<footer id="footer">
