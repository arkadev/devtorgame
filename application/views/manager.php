...
<html lang="es">
    ...
    <body style="background-color: #EEEEEE">
        <div class="row">
         ...
         <div class="row">
            <div id="crearTorneo" name="add-tournament-btn">
    ...
    if (is_array($tournaments) || is_object($tournaments)) {
        foreach ($tournaments as $t) {
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-0" id="nnnnn<?= $t->name; ?>">
                    <a href="<?= base_url() . 'index.php/team'?>?name_tournament=<?php echo $t->name?>">
                        <div class="add-tournament add-img-btn" style="width:260px;background-color:<?= $t->color; ?>">
                            <div>
                                <img src="<?= base_url() . 'assets/img/lol11.jpg'?>" class="img-responsive margin-icon" >
                            </div>
                            <div class="tournamet-crete">
                                <h3 class="color-text-tournament"><?= $t->name; ?></h3>
                                <h5 class="color-text-tournament"><?= $t->description; ?></h5>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-10">
                    <div class="modal-content">
                        <div class="add-img-btn">
                            <img id="image-baner" src="<?= base_url() . 'assets/img/lol11.jpg'?>" class="img-responsive">
                        </div>
                        <div id="baner-color" class="add-dates-tournametn" background-color:"#029AE4">
                            <div>
                                <input id="name" type="text" class="text-name-tournament" placeholder="Nombre de torneo">
                            </div>
                            <div id="textarea-line">
                                <textarea class="text-name-tournament" rows="1" id="description" placeholder="Descripcion del torneo"></textarea>
                            </div>
                        </div>
